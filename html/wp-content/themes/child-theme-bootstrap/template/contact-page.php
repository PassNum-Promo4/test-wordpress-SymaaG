					...
					<div class="col-12 row d-flex justify-content-center ">
						<form class="col-lg-8 col-md-12 col-sm-12 row  " action="index.html" method="post">
							...
							<div class="col-12 row d-flex justify-content-start m-3  ">
								...
								<input class="col-8 form-control" type="text" name="nom" value="">
							</div>
							<div class="col-12 row d-flex justify-content-start m-3  ">
								<label for="#prenom" class="col-4" for="">Prénom :</label>
								<input id="prenom" class="col-8 form-control" type="text" name="prenom" value="">
							</div>
							<div class="col-12 row d-flex justify-content-start m-3">
								<label for="#email" class="col-4" for="">Email :</label>
								<input id="email" class="col-8 form-control" type="mail" name="mail" value="">
							</div>
							<div class="col-12 row d-flex justify-content-start m-3">
								<label for="#object" class="col-4" for="">Object :</label>
								<input id="object" class="col-8 form-control" type="text" name="objet" value="">
							</div>
							<div class="col-12 row d-flex justify-content-start m-3">
